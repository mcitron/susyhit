...
c end change susyhit
      ...
      character(len=1000) slha_file
      CALL GETARG(1,slha_file) 

      CALL READ_HDEC(TGBET,AMABEG,AMAEND,NMA,slha_file)
      if(islhao.ne.1) then
...
c end change susyhit
      ...
      SUBROUTINE READ_HDEC(TGBET,AMABEG,AMAEND,NMA,slha_file)
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      character(len=1000) slha_file
